class AuthorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @author.save
        format.html { redirect_to authors_path(@author), notice: "Author was successfully created." }
  ...
  def update
    respond_to do |format|
      if @author.update(author_params)
        format.html { redirect_to authors_path(@author), notice: "Author was successfully updated." }
